...
static float bandMagHistory[NUM_BOXES][HIST_NUM] = {0.0f};
...
static uint8_t kBeatDetectBand = 2;

static float kBeatThreshold = 4.0f;

static float beatHist_[FREQ_BAND_COUNT][5] = {0.0f};

static uint8_t beatVisIntensity_ = 0;
bool setupI2Smic();
